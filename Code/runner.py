...
pygame.display.set_caption("Path Finder in Maze")

RectButtonFont = pygame.font.Font("Code/OpenSans-Regular.ttf", 16)
CirButtonFont = pygame.font.Font("Code/OpenSans-Regular.ttf", 40)
...
colors = {
    ...
    "p_yellow": (255, 255, 0), # shortest path
